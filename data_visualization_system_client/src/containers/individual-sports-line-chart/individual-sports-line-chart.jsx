...
import {lineChartOption} from './sports-line-chart-option-config'
import {connect} from "react-redux";
import {dataWithDatetime_1, weekdayDate_1} from "./simulate-health-data";

class IndividualSportsLineChart extends Component {
    ...
    render() {
        ...
        const {stepData} = userHealthState ;
        const stepDate = this.getDateFromData(stepData) ;
...
export default connect(mapStateToProps, mapDispatchToProps)(IndividualSportsLineChart) ;
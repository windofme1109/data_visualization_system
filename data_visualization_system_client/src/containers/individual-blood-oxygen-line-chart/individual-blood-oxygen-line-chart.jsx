...
import {lineChartOption} from './blood-oxygen-line-option-config'
import {dataWithDatetime_1, weekdayDate_1} from "./simulate-health-data";
import {connect} from "react-redux";

class IndividualBloodOxygenLineChart extends Component {
    ...
    render() {
        ...
        const {bloodoxygenData} = userHealthState ;
        const bloodoxygenDate = this.getDateFromData(bloodoxygenData) ;
...
export default connect(mapStateToProps, mapDispatchToProps)(IndividualBloodOxygenLineChart) ;